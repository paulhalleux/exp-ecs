...
export class QueryTracker {
  ...
  constructor(
    ...
    private readonly query: QueryComponent,
  ) {}
...
export class Query {
  static has(...components: ComponentType<any, any>[]): QueryComponent {
    return { all: components };
  }

  static any(...components: ComponentType<any, any>[]): QueryComponent {
    return { any: components };
  }

  static none(...components: ComponentType<any, any>[]): QueryComponent {
    return { none: components };
  }

  static only(...components: ComponentType<any, any>[]): QueryComponent {
    return { only: components };
  }

  static and(...queries: QueryComponent[]): QueryComponent {
    return { and: queries };
  }

  static or(...queries: QueryComponent[]): QueryComponent {
    return { or: queries };
  }

  static not(query: QueryComponent): QueryComponent {
    return { not: query };
  }
}
